    ...
    <div className="pt-32 pb-36 px-10">
      ...
      <Popup
        trigger={
          <div>
            <button
              className="fixed z-50 bottom-10 right-10 h-20 w-20 justify-center flex flex-col items-center bg-blue-200 rounded-lg hover:bg-blue-500"
